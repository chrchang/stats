...
MPFR-comparison and benchmark scripts under utils/ .  E.g.
    ...
    n=(2^5)-1: base=7.13e-07  approx=3.17e-07  scipy=2.97e-05 sec/iter
    n=(2^20)-1: base=2.58e-06  approx=1.44e-06  scipy=2.98e-05 sec/iter
    n=(2^35)-1: base=1.45e-06  approx=1.01e-06  scipy=9.68e-05 sec/iter
    ...
    n=(2^5)-1: base=9.58e-07  scipy=0.000238 sec/iter
    n=(2^20)-1: base=4.23e-06  scipy=0.000557 sec/iter
    n=(2^35)-1: base=5.92e-06  scipy=0.000883 sec/iter
